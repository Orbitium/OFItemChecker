...
public final class OFItemChecker extends JavaPlugin {

    private static OFItemChecker instance;
    public static boolean checkOPPlayers;
    public static String infoLogText;
    private static boolean logDeletedItems;
    ...
    public void onEnable() {
        ...
        infoLogText = getConfig().getString("messages.itemRemoveInfo");

        logDeletedItems = getConfig().getBoolean("messages.enabled");
    ...
    public static OFItemChecker getInstance() {
        return instance;
    }
